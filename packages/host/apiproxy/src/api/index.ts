...
import type { WorkSchedulerApi } from './work-scheduler.ts'
...
export interface ApiProxy {
  ...
  llm: LlmApi
  workScheduler: WorkSchedulerApi
...
export type {
  SchedulerProcess, SchedulerTask, SchedulerTaskOrigin, SchedulerTaskStatus,
  WorkSchedulerApi, WorkSchedulerDocument, WorkSchedulerStore,
...
// The durable document vocabulary, exported for the host store's domain spec:
// the wire and durable boundaries share one schema (see work-scheduler.schema).
export { workSchedulerDocumentSchema } from './work-scheduler.schema.ts'
