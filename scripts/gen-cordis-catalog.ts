...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  workSchedulerStore: 'interface-typed Host service; WorkSchedulerStoreService implements it — packages/work-scheduler/work-scheduler-store/README.md owns the API',
