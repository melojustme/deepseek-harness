...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/bundle/work-scheduler': { kind: 'none', reason: 'The bundle inserts browser and Host persistence plugins that keep scheduler documents outside model requests.' },
