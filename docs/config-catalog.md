...
- `@deepseek-ai/dsh-tool-work-scheduler` — requires `agents` · `tools` · `workspaceRegistry` · `workSchedulerStore` ([`packages/work-scheduler/tool-work-scheduler/src/index.ts`](../packages/work-scheduler/tool-work-scheduler/src/index.ts))
- `@deepseek-ai/dsh-user-questions` ([`packages/interaction/user-questions/src/index.ts`](../packages/interaction/user-questions/src/index.ts))
- `@deepseek-ai/dsh-work-scheduler-store` — requires `storageDomain` ([`packages/work-scheduler/work-scheduler-store/src/index.ts`](../packages/work-scheduler/work-scheduler-store/src/index.ts))
